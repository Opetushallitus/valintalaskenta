...
public class ValinnanvaiheMappingTest {
	...
	public void testaaMappaus() {
		...
		ValinnanvaiheDTO v = new Gson().fromJson(
				new InputStreamReader(ValinnanvaiheMappingTest.class
						.getResourceAsStream("valinnanvaiheDTO.json")),
		...
		Assert.assertEquals("Oidit ei ole samoja!", v.getValinnanvaiheoid(),
				v1.getValinnanvaiheOid());
	}
}
