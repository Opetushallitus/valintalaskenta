...
public interface TulosValinnanvaiheRepository extends CrudRepository<Valinnanvaihe, UUID> {
  ...
  @Query(
      "select jono.aloituspaikat, jono.ei_varasijatayttoa, jono.kaytetaan_valintalaskentaa, jono.kaikki_ehdon_tayttavat_hyvaksytaan, "
          ...
          + "js.id as jonosija_id, js.hakemus_oid, js.hakija_oid, js.syotetyt_arvot, js.hakutoiveprioriteetti, js.harkinnanvarainen, js.hylatty_valisijoittelussa, "
          + "kri.tila, kri.arvo, kri.prioriteetti as kriteeri_prioriteetti, kri.nimi as kriteeri_nimi, kri.kuvaus_fi, kri.kuvaus_sv, kri.kuvaus_en "
          ...
          + "where vv.hakukohde_oid = :hakukohdeOid")
  List<SijoitteluMorko> haeSijoittelutiedot(@Param("hakukohdeOid") String hakukohdeOid);
