...
public class TulosValinnanvaiheDaoTest extends AbstractIntegrationTest {
  ...
  @Autowired
  private TulosValinnanvaiheDAO tulosValinnanvaiheDAO;

  @Test
  public void testHaeTuloksetValinnantapajonolle() {
    valinnanvaiheRepository.save(TestDataUtil.luoValinnanvaiheEntity("haku1", "hakukohde1", 1, "vaihe1",
      List.of(TestDataUtil.luoValintatapaJonoEntity(0, new HashSet<>(), "jono1nimi", 0, null, "jono1"))));
