...
public class ValintaLaskentaLaskentaTestApplication implements WebApplicationInitializer {
  ...
  public void onStartup(final ServletContext container) throws ServletException {
    ...
    final FilterRegistration.Dynamic signOutFilter =
        container.addFilter("signOut", new OpintopolkuSingleSignOutFilter());
    ...
    final ServletRegistration.Dynamic exporter =
        container.addServlet("exporter", new DispatcherServlet());
