...
public class DevApp {
  ...
  public static void main(String[] args) {
    ...
    System.setProperty("host.host-virkailija", String.format("virkailija.%sopintopolku.fi", ENVIRONMENT));
    System.setProperty("host.host-alb", "http://localhost:8888");

    System.setProperty(
        "cas-service.service",
        String.format("https://virkailija.%sopintopolku.fi/valintalaskenta-laskenta-service", ENVIRONMENT));
