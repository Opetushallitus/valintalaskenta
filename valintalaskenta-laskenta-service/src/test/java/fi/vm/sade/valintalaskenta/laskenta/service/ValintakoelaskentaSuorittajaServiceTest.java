...
public class ValintakoelaskentaSuorittajaServiceTest {
    ...
    public void testMustache() {
        ...
        valintakoelaskentaSuorittajaService.laske(hakemus, Collections.singletonList(valintaperusteet1), uuid, kumulatiivisetTulokset, korkeakouluhaku);
    ...
    public void testViimeisinValinnanvaihe() {
        ...
        when(edellinenValinnanvaiheKasittelijaMock.tilaEdellisenValinnanvaiheenMukaan(Matchers.any(), Matchers.any(), Matchers.eq(viimeisin1), any(ValintaperusteetDTO.class), any(ValintakoeOsallistuminen.class)))
            .thenReturn(ts0);
        when(edellinenValinnanvaiheKasittelijaMock.tilaEdellisenValinnanvaiheenMukaan(Matchers.any(), Matchers.any(), Matchers.eq(viimeisin2), any(ValintaperusteetDTO.class), any(ValintakoeOsallistuminen.class)))
            .thenReturn(ts1);
        ...
        when(valintakoeosallistumislaskinMock.laskeOsallistuminenYhdelleHakukohteelle(
            argThat(hasOid(hakukohdeOid1)), Matchers.any(), Matchers.any()))
            .thenReturn(osallistuu1);

        when(valintakoeosallistumislaskinMock.laskeOsallistuminenYhdelleHakukohteelle(
            argThat(hasOid(hakukohdeOid2)), Matchers.any(), Matchers.any()))
    ...
    public void testEdellisetValinnanvaiheet() {
        ...
        when(edellinenValinnanvaiheKasittelijaMock.tilaEdellisenValinnanvaiheenMukaan(Matchers.any(), Matchers.any(), Matchers.eq(v0), any(ValintaperusteetDTO.class), any(ValintakoeOsallistuminen.class)))
            .thenReturn(ts0);
        when(edellinenValinnanvaiheKasittelijaMock.tilaEdellisenValinnanvaiheenMukaan(Matchers.any(), Matchers.any(),Matchers.eq(v1), any(ValintaperusteetDTO.class), any(ValintakoeOsallistuminen.class)))
            .thenReturn(ts1);
