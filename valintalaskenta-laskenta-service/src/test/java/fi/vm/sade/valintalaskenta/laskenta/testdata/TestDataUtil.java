...
public abstract class TestDataUtil {
    ...
    public static HakemusDTO luoHakemus(String hakuOid, String hakemusOid, String hakijaOid, String... hakutoiveet) {
    ...
    public static ValintaperusteetDTO luoValintaperusteetJaValintakoeValinnanvaihe(String hakuOid, String hakukohdeOid, String valinnanVaiheOid, int valinnanVaiheJarjestysluku, String... valintakoeTunnisteet) {
        ValintaperusteetDTO perusteet = luoValintaperusteet(hakuOid, hakukohdeOid);
        perusteet.setValinnanVaihe(luoValintakoeValinnanVaihe(valinnanVaiheOid, valinnanVaiheJarjestysluku, Koekutsu.YLIN_TOIVE, "kutsunKohdeAvain", valintakoeTunnisteet));
        return perusteet;
    }

    public static ValintaperusteetDTO luoValintaperusteetJaTavallinenValinnanvaihe(String hakuOid, String hakukohdeOid, String valinnanVaiheOid, int valinnanVaiheJarjestysluku) {
        ValintaperusteetDTO perusteet = luoValintaperusteet(hakuOid, hakukohdeOid);
        perusteet.setValinnanVaihe(luoTavallinenValinnanvaihe(valinnanVaiheOid, valinnanVaiheJarjestysluku));
        return perusteet;
    }

    public static ValintaperusteetValinnanVaiheDTO luoTavallinenValinnanvaihe(String valinnanVaiheOid, int valinnanVaiheJarjestysluku) {
    ...
    public static ValintatapajonoJarjestyskriteereillaDTO luoValintatapajono(String valintatapajonoOid, int prioriteetti, int aloituspaikat, ValintaperusteetJarjestyskriteeriDTO... jarjestyskriteerit) {
    ...
    public static ValintaperusteetJarjestyskriteeriDTO luoJarjestyskriteeri(ValintaperusteetFunktiokutsuDTO funktiokutsu, int prioriteetti) {
    ...
    public static ValintaperusteetDTO luoValintaperusteetJaValintakoeValinnanVaihe(String hakuOid, String hakukohdeOid, String valinnanVaiheOid, int valinnanVaiheJarjestysluku, Map<String, FunktiokutsuDTO> valintakokeetJaKaavat, Koekutsu kutsunKohde, String kutsunKohdeAvain) {
        ValintaperusteetDTO perusteet = luoValintaperusteet(hakuOid, hakukohdeOid);
        perusteet.setValinnanVaihe(luoValinnanVaihe(valinnanVaiheOid, valinnanVaiheJarjestysluku, valintakokeetJaKaavat, kutsunKohde, kutsunKohdeAvain));
        return perusteet;
    }

    public static ValintaperusteetValinnanVaiheDTO luoValintakoeValinnanVaihe(String valinnanVaiheOid, int jarjestysluku) {
        ValintaperusteetValinnanVaiheDTO vaihe = new ValintaperusteetValinnanVaiheDTO();
        vaihe.setValinnanVaiheOid(valinnanVaiheOid);
    ...
    private static ValintaperusteetValinnanVaiheDTO luoValinnanVaihe(String valinnanVaiheOid, int valinnanVaiheJarjestysluku, Map<String, FunktiokutsuDTO> valintakokeetJaKaavat, Koekutsu kutsunKohde, String kutsunKohdeAvain) {
        ValintaperusteetValinnanVaiheDTO vaihe = luoValintakoeValinnanVaihe(valinnanVaiheOid, valinnanVaiheJarjestysluku);
    ...
    public static ValintaperusteetValinnanVaiheDTO luoValintakoeValinnanVaihe(String valinnanVaiheOid, int jarjestysluku, Koekutsu kutsunKohde, String kutsunKohdeAvain, String... valintakoeTunnisteet) {
        ValintaperusteetValinnanVaiheDTO vaihe = luoValintakoeValinnanVaihe(valinnanVaiheOid, jarjestysluku);
    ...
    public static ValintakoeDTO luoValintakoe(String valintakoeOid, String tunniste, Koekutsu kutsunKohde, String kutsunKohdeAvain) {
    ...
    public static HakukohdeValintakoeData luoHakukohdeValintakoeData(String hakukohdeOid, Osallistuminen osallistuminen, String valintakoeTunniste) {
