...
public class ValintaLaskentaLaskentaJettyForTesting {
  public static final int port =
      Integer.parseInt(
          System.getProperty(
              "valintalaskenta-laskenta.port", String.valueOf(PortChecker.findFreeLocalPort())));
  public static final String rootUrl =
      "http://localhost:" + port + "/valintalaskenta-laskenta-service/resources";
  ...
  public static void startShared() {
    try {
      ...
      ValintaLaskentaLaskentaJetty.JETTY.start(
          wac, server, ValintaLaskentaLaskentaJetty.CONTEXT_PATH);
    } catch (Throwable t) {
