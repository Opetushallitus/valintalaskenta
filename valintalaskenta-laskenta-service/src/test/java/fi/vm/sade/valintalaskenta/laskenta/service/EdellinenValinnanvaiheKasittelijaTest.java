...
public class EdellinenValinnanvaiheKasittelijaTest {
  private final EdellinenValinnanvaiheKasittelija edellinenValinnanvaiheKasittelija =
      new EdellinenValinnanvaiheKasittelija(mock(MuokattuJonosijaDAO.class));
  ...
  public void testHylattyEdellisenVaiheenMukaan() {
    ...
    TilaJaSelite tilaJaSelite =
        edellinenValinnanvaiheKasittelija.tilaEdellisenValinnanvaiheenTilanMukaan(
            laskettuTila, edellisenVaiheenTila);
  ...
  public void testHyvaksyttavissaEdellisenVaiheenMukaanLaskettuTilaHylatty() {
    ...
    Tila laskettuTila =
        new Hylattytila(suomenkielinenMap(lasketuntilanSelite), new Arvokonvertterihylkays(""));
  ...
  public void testHyvaksyttavissaEdellisenVaiheenMukaanLaskettuTilaVirhe() {
    ...
    final String lasketuntilanSelite = "toinenSelite";
    Tila laskettuTila =
        new Virhetila(suomenkielinenMap(lasketuntilanSelite), new ArvokonvertointiVirhe(""));
  ...
  public void test() {
    ...
    TilaJaSelite tilaJaSelite =
        edellinenValinnanvaiheKasittelija.tilaEdellisenValinnanvaiheenMukaan(
            hakemusOid, new Hyvaksyttavissatila(), edellinenVaihe);
    assertEquals(JarjestyskriteerituloksenTila.HYVAKSYTTAVISSA, tilaJaSelite.getTila());
    assertTrue(tilaJaSelite.getSelite().isEmpty());
  }
}
