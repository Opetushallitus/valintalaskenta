  ...
  public void valisijoiteltavatJonotTest() {
    ...
    LaskeDTO hakukohde1 =
        new LaskeDTO(
            ...
            "hakukohde1",
            new ArrayList<>(),
            Arrays.asList(perusteet1, perusteet2, perusteet3));
    LaskeDTO hakukohde2 =
        new LaskeDTO(
            null,
            false,
            ...
            "hakukohde2",
            new ArrayList<>(),
            Arrays.asList(perusteet4, perusteet5));
    StopWatch stopWatch = new StopWatch();
    ValisijoitteluKasittelija.ValisijoiteltavatJonot jonot =
        valisijoitteluKasittelija.valisijoiteltavatJonot(
            Arrays.asList(hakukohde1, hakukohde2), stopWatch);
