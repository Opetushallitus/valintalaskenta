...
/**
 * Monessako jonossa hakemus esiintyy ja monestiko hakemus on hyväksytty. Jos hakemus ei ole
 * hyväksytty kertaakaan niin hakemus on hylättävä jatkossa vaikka myöhemmissä vaiheissa tulisi
 * onnistumisia.
 */
