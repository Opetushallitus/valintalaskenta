...
public class ValintakoeosallistumislaskinImpl implements Valintakoeosallistumislaskin {
  ...
  @Autowired
  public ValintakoeosallistumislaskinImpl(
      LaskentaService laskentaService,
      LaskentadomainkonvertteriWrapper laskentadomainkonvertteriWrapper) {
      ...
      case TOTUUSARVOFUNKTIO:
        Laskentatulos<Boolean> tulos =
            laskentaService.suoritaValintakoelaskenta(
                hakukohde,
                hakemus,
                laskentadomainkonvertteriWrapper.muodostaTotuusarvolasku(kaava));
        return muodostaTulos(tulos);

      case LUKUARVOFUNKTIO:
        Laskentatulos<BigDecimal> lukuarvotulos =
            laskentaService.suoritaValintakoelaskenta(
                hakukohde, hakemus, laskentadomainkonvertteriWrapper.muodostaLukuarvolasku(kaava));
