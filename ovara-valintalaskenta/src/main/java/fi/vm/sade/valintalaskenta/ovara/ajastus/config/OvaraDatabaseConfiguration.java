...
import fi.vm.sade.valintalaskenta.ovara.ajastus.SiirtotiedostoInfo;
...
class OvaraDatabaseConfiguration extends AbstractJdbcConfiguration {
  ...
  public JdbcCustomConversions jdbcCustomConversions() {
    ...
    JSON_CLASSES.forEach(
        clazz -> {
          converters.add(new OvaraDatabaseConfiguration.ObjectToJSONB<>(clazz));
          converters.add(new OvaraDatabaseConfiguration.JSONBToObject<>(clazz));
        });
