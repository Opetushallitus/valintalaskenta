...
public class JonosijaDTOComparator implements Comparator<JonosijaDTO> {
  ...
  public int compare(JonosijaDTO thiz, JonosijaDTO other) {
    ...
    boolean thizVirhe =
        (thiz.getTuloksenTila() != null
                && thiz.getTuloksenTila() == JarjestyskriteerituloksenTila.VIRHE)
            || !thiz.getJarjestyskriteerit().isEmpty()
                && thiz.getJarjestyskriteerit().first().getTila()
                    == JarjestyskriteerituloksenTila.VIRHE;

    boolean otherVirhe =
        other.getTuloksenTila() != null
                && other.getTuloksenTila() == JarjestyskriteerituloksenTila.VIRHE
            || !other.getJarjestyskriteerit().isEmpty()
                && other.getJarjestyskriteerit().first().getTila()
                    == JarjestyskriteerituloksenTila.VIRHE;
    ...
    boolean thizHarkinanvaraisestiHyvaksytty =
        (thiz.getTuloksenTila() != null
                && thiz.getTuloksenTila()
                    == JarjestyskriteerituloksenTila.HYVAKSYTTY_HARKINNANVARAISESTI)
            || !thiz.getJarjestyskriteerit().isEmpty()
                && thiz.getJarjestyskriteerit().first().getTila()
                    == JarjestyskriteerituloksenTila.HYVAKSYTTY_HARKINNANVARAISESTI;
    boolean otherHarkinanvaraisestiHyvaksytty =
        other.getTuloksenTila() != null
                && other.getTuloksenTila()
                    == JarjestyskriteerituloksenTila.HYVAKSYTTY_HARKINNANVARAISESTI
            || !other.getJarjestyskriteerit().isEmpty()
                && other.getJarjestyskriteerit().first().getTila()
                    == JarjestyskriteerituloksenTila.HYVAKSYTTY_HARKINNANVARAISESTI;
    ...
    boolean thizHylatty =
        (thiz.getTuloksenTila() != null
                && thiz.getTuloksenTila() == JarjestyskriteerituloksenTila.HYLATTY)
            || !thiz.getJarjestyskriteerit().isEmpty()
                && thiz.getJarjestyskriteerit().first().getTila()
                    == JarjestyskriteerituloksenTila.HYLATTY;

    boolean otherHylatty =
        other.getTuloksenTila() != null
    ...
    Map<Integer, JarjestyskriteeritulosDTO> thizJarjestyskriteerit =
        jarjestyskriteeritPrioriteetinMukaan(thiz.getJarjestyskriteerit());
    Map<Integer, JarjestyskriteeritulosDTO> otherJarjestyskriteerit =
        jarjestyskriteeritPrioriteetinMukaan(other.getJarjestyskriteerit());
